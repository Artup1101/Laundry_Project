...
<body class="g-sidenav-show   bg-gray-100">
  <div class="min-height-300 position-absolute w-100" style="background-color: #9400D3"></div>
    ...
    <div class="card shadow-lg">
      <div class="card-header pb-0 pt-3 ">
        <div class="float-start">
          <h4 class="mt-3 mb-0">Laundrycuuuu</h4>
          <p>Dashboard Option</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0 overflow-auto">
        ...
        <div class="mt-3">
          ...
          <p class="text-sm">2 different sidenav types.</p>
        </div>
        <div class="d-flex">
        ...
        <hr class="horizontal dark my-sm-4">
        <div class="d-flex">
        <a href="{{route('logout')}}" class="btn bg-gradient-danger w-100 px-3 mb-2" data-class="bg-default" onclick="sidebarType(this)">LogOut</a>
        </div>
